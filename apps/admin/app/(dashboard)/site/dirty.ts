...
const LEAF_LABELS: Record<string, string> = {
  ...
  giftPriceCents: 'Preț cadou',
  basePriceCents: 'Preț bază',
  standardPriceCents: 'Preț tăiat (vechi)',
  premiumExtraCents: 'Suprataxă premium',
  tipSurchargePercent: 'Procent dedicație',
  tipSurchargeCapCents: 'Plafon dedicație',
