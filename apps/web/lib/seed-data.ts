...
export const VOICES = [
  { id: 'male', nm: 'Bărbătească', tg: 'Voce de bărbat', av: '♂', ic: { name: 'Mic', fill: 'none', stroke: '#f59e0b', strokeWidth: 2 } },
  { id: 'female', nm: 'Feminină', tg: 'Voce de femeie', av: '♀', ic: { name: 'Flower2', fill: '#ec4899', stroke: '#db2777', strokeWidth: 1.5 } },
];
