  ...
  return (
    ...
    >
      <p className="mb-3 leading-relaxed">
        Folosim cookie-uri și colectăm date de utilizare (sesiune, dispozitiv, geo aproximativ) pentru a îmbunătăți experiența și a măsura performanța campaniilor.
        Detalii în{' '}
