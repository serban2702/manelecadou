...
export class PublicSiteController {
  ...
  private serialize(site: Site, publicOnly: boolean, req: Request) {
    return {
      ...
      langSwitcherEnabled: site.langSwitcherEnabled ?? false,
...
export class AdminSitesController {
  ...
  private serializeFull(s: Site) {
    return {
      ...
      aiGreetingEnabled: s.aiGreetingEnabled ?? false,
      aiGreetingDelaySec: s.aiGreetingDelaySec ?? 5,
      aiGreetingAutoOpenChat: s.aiGreetingAutoOpenChat ?? true,
